...
namespace RDotNet
{
	...
	public class REngine : UnmanagedDll
	{
        ...
        /// <summary>
        /// Calls the 'error' function in the R API. 
        /// </summary>
        /// <param name="errorMsg">The error message</param>
        /// <remarks>This is useful primarily in a scenario where .NET is embedded in R, probably not when R is embedded in .NET</remarks>
	    public void Error(string errorMsg)
	    {
            GetFunction<Rf_error>("Rf_error")(errorMsg);
	    }
