...
#' Type: \tab Package\cr
#' Version: \tab 0.7-7\cr
#' Notes: \tab Update to use R.NET 1.6.4. Functionally unchanged otherwise. \cr
...
#' 0.7-6: \tab 2015-04-06 \tab update the R Markdown vignettes to work with the latest version of knitr \cr
